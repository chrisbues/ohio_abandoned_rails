...
| **ODOT Railroad Crossing Inventory** (`tims.dot.state.oh.us/ags/rest/services/Assets/Rail_Crossing_Inventory`) | 🟢 | ~8,500 inventoried grade crossings with open/closed status, railroad, street, and DOT crossing number. Integrated as a toggleable point overlay — closed crossings pinpoint where lost grades met roads. |
...
| **OSIP (Ohio Statewide Imagery Program)** most-current cache (`maps.ohio.gov/image/rest/services/osip_most_current_cache`) | 🟢 | The state's own high-res orthophotos as a standard Web Mercator tile cache; integrated as a basemap. |
| **ODNR historical imagery stack** (`gis.ohiodnr.gov/image/rest/services/OIT_Services`) | 🟢 | Public Web Mercator tile caches integrated as the "Ohio Historical" basemap with a vintage picker: **OSIP 2006 1-ft leaf-off** (+ color-infrared variant), **USGS B/W DOQQ aerials 1988–1999**, **NAIP 2004–2017** (7 vintages), and scanned **USGS topo quads** at 1:24,000 and 1:62,500 — old rail lines are drawn directly on the topos. |
| **OSIP III cache** (`maps.ohio.gov/image/rest/services/osip_3_cache`) | 🟢 | ~2017–2019 leaf-off statewide flight; included in the historical vintage picker. |
